...
export function FiltersSidebar({
  ...
  return (
    <form action="/loja" method="GET" className="space-y-6 rounded-lg border border-ink-100 bg-white p-5">
      ...
      <div>
        ...
        <div className="space-y-2">
          <label className="flex items-center gap-2 text-sm text-ink-600">
            <input type="radio" name="categoria" value="" defaultChecked={!current.categoria} className="accent-brand-600" />
            Todas as categorias
          </label>
          {categories.map((c) => (
      ...
      <div className="border-t border-ink-100 pt-5">
        ...
        <Select name="marca" defaultValue={current.marca ?? ""}>
      ...
      <div className="border-t border-ink-100 pt-5">
        ...
        <div className="flex items-center gap-2">
          <Input type="number" name="preco_min" placeholder="Mín." defaultValue={current.preco_min} min={0} />
          <span className="text-ink-400">—</span>
          <Input type="number" name="preco_max" placeholder="Máx." defaultValue={current.preco_max} min={0} />
        </div>
      </div>

      <div className="border-t border-ink-100 pt-5">
        <h3 className="mb-3 text-sm font-bold text-ink-900">Condição</h3>
        <Select name="condicao" defaultValue={current.condicao ?? ""}>
      ...
      <div className="border-t border-ink-100 pt-5">
        ...
        <Select id="ordenar" name="ordenar" defaultValue={current.ordenar ?? "relevancia"}>
      ...
      <div className="grid gap-2 pt-2">
        ...
        <Button href="/loja" variant="ghost" size="sm" className="justify-center">
          Limpar Filtros
        </Button>
      </div>
    </form>
