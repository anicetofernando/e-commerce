    ...
    <Container className="max-w-3xl py-14">
      ...
      <div className="prose-sm mt-8 space-y-6 text-sm leading-relaxed text-ink-600">
        <section>
          ...
          <p>
            Estes Termos e Condições regulam o acesso e utilização do site da Albimaq Peças ({CONTACT_INFO.companyName}),
        ...
        <section>
          ...
          <p>
            ...
            <a href={`mailto:${CONTACT_INFO.email}`} className="text-brand-600 hover:underline">{CONTACT_INFO.email}</a>.
          </p>
        </section>
      </div>
    </Container>
