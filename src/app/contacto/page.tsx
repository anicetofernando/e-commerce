          ...
          <div className="rounded-lg border border-ink-100 bg-white p-6">
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span className="text-ink-600">{CONTACT_INFO.address}</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone size={18} className="shrink-0 text-brand-600" />
                <a href={`tel:${CONTACT_INFO.phonePrimary}`} className="text-ink-600 hover:text-brand-600">
                  {CONTACT_INFO.phonePrimary}
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail size={18} className="shrink-0 text-brand-600" />
                <a href={`mailto:${CONTACT_INFO.email}`} className="text-ink-600 hover:text-brand-600">
                  {CONTACT_INFO.email}
                </a>
              </li>
              <li className="flex items-start gap-3">
                <Clock size={18} className="mt-0.5 shrink-0 text-brand-600" />
                <span className="text-ink-600">{CONTACT_INFO.hours}</span>
              </li>
            </ul>
          </div>
